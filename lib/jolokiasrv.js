  ...
  */
  ...
  JolokiaSrv = (function() {
    ...
    function JolokiaSrv(interval) {
      this.stop_gmond_service = __bind(this.stop_gmond_service, this);
      this.start_gmond_service = __bind(this.start_gmond_service, this);
      ...
      this.remove_all_attributes = __bind(this.remove_all_attributes, this);
    ...
    */
    ...
    JolokiaSrv.prototype.add_attribute = function(name, group, stat, attr, data) {
      var _base, _base1, _base2;
      (_base = this.jclients[name])[group] || (_base[group] = new Object());
      (_base1 = this.jclients[name][group])[stat] || (_base1[stat] = new Object());
      return (_base2 = this.jclients[name][group][stat])['attributes'] || (_base2['attributes'] = new Object());
    };
    ...
    */
    ...
    JolokiaSrv.prototype.remove_all_attributes = function(name) {
      var _this = this;
      return async.forEach(Object.keys(this.jclients[name]), function(key, fn) {
        delete _this.jclients[name][key];
        return fn(null, true);
      }, function(err) {});
    };
    ...
    */
    ...
    JolokiaSrv.prototype.start_gmond_service = function() {};
    ...
    */
    ...
    JolokiaSrv.prototype.stop_gmond_service = function() {};
