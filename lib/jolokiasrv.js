  ...
  */
  ...
  JolokiaSrv = (function() {
    ...
    function JolokiaSrv(interval) {
      ...
      this.merge_composites = __bind(this.merge_composites, this);
      this.merge_attributes = __bind(this.merge_attributes, this);
      this.merge_mbean = __bind(this.merge_mbean, this);
    ...
    */
    ...
    JolokiaSrv.prototype.merge_mappings = function(base, extension) {
      var base_mbean, extended, map, merged_map, _i, _len;
      extended = [];
      merged_map = base;
      for (_i = 0, _len = extension.length; _i < _len; _i++) {
        map = extension[_i];
        extended.push(map.mbean);
        base_mbean = (base.filter(function(X) {
          return X.mbean === map.mbean;
        })).pop();
        console.log('hi bob!');
        console.log(base_mbean);
        console.log(map);
        this.merge_mbean(base_mbean, map);
      }
      return base;
    };
    ...
    */
    ...
    JolokiaSrv.prototype.merge_mbean = function(base, extension) {
      if (base === void 0) {
        return extension;
      } else {
        return extension;
    ...
    */
    ...
    JolokiaSrv.prototype.merge_attributes = function(base, extension) {
      return null;
    };
    ...
    */
    ...
    JolokiaSrv.prototype.merge_composites = function(base, extension) {
              ...
              _results1.push((function() {
                ...
                for (_k = 0, _len2 = _ref2.length; _k < _len2; _k++) {
                  ...
                  if (c.hasOwnProperty('graph') && c.hasOwnProperty('value')) {
                    _results2.push(compile_and_submit_metric(client, c.graph, c.value, cluster));
                  } else {
