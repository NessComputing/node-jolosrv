  ...
  */
  ...
  CLI = (function() {
    ...
    function CLI() {
      ...
      this.argv = optimist.usage("Usage: " + exports.name).alias('c', 'config').describe('c', 'The configuration file to use')["default"]('c', "/etc/jolosrv.json").alias('t', 'template_dir').describe('t', 'The template directory to watch')["default"]('t', '/opt/jolosrv/templates').alias('e', 'cluster_prefix').describe('e', 'The ganglia gmond cluster prefix')["default"]('e', null).alias('C', 'cluster').describe('C', 'The default gmond cluster')["default"]('C', 'unspecified').alias('g', 'gmetric').describe('g', 'The gmond host to send gmetric data to')["default"]('g', '127.0.0.1').alias('P', 'gPort').describe('P', 'The gmond port to send gmetric data to')["default"]('P', 8649).alias('l', 'loglevel').describe('l', 'Set the log level (debug, info, warn, error, fatal)')["default"]('l', 'warn').alias('p', 'port').describe('p', 'Run the api server on the given port')["default"]('p', 3000).alias('h', 'help').describe('h', 'Shows this message')["default"]('h', false).argv;
      this.configure();
