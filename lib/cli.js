  ...
  */
  ...
  CLI = (function() {
    ...
    function CLI() {
      ...
      this.argv = optimist.usage("Usage: " + exports.name).alias('c', 'config').describe('c', 'The configuration file to use')["default"]('c', "/etc/jolosrv.json").alias('H', 'redis_host').describe('H', 'The redis host to connect')["default"]('H', "127.0.0.1").alias('P', 'redis_port').describe('P', 'The redis port to connect')["default"]('P', "6379").alias('l', 'loglevel').describe('l', 'Set the log level (debug, info, warn, error, fatal)')["default"]('l', 'warn').alias('p', 'port').describe('p', 'Run the api server on the given port')["default"]('p', 3000).alias('h', 'help').describe('h', 'Shows this message')["default"]('h', false).argv;
      this.configure();
